...
<body>
		...
		<div id="new">
				<input type="button" value="Add Question" onClick="addelement();"/>
		</div>
		...
		<div id ="newelement">
				<form method ="post" action="hi.php" id="t">
					...
					<button type='submit' style="margin-left: 300px; background-color: green; color: lightgreen;" >Submit</button>	
					<br>
				</form>
			</div> 
