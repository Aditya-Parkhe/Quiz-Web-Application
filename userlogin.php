...
<a class="but" onclick="location.href='adminlogin.php';">User Login</a>

<a  class="but" onclick="location.href='#';">Help</a>
</div>
...
<div class="login-box">
  ...
  <!-- ======= Sign in ======= -->
  <input class="btn" type="submit" style="margin-top: 30px;" name="" value="Sign In" /><br>
  
    </div>
  </form>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.5.2/js/bo
</div>
</body>
</html>